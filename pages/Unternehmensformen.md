...
```mermaid
graph TD
    U[Unternehmensformen] --> E[Einzelunternehmung]
    U --> G[Gesellschaftsunternehmungen]
    G --> P[Personengesellschaften]
    G --> K[Kapitalgesellschaften]
    G --> eG[Genossenschaften]
    P --> GbR[GbR]
    P --> OHG[OHG]
    P --> KG[KG]
    K --> GmbH[GmbH]
    K --> UG[UG haftungsbeschränkt]
    K --> AG[AG]
    eG --> eGn[eG eingetragene Genossenschaft]
```
